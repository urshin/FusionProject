...
public class MagicLazer : NetworkBehaviour
{
    //}
    [Header("Prefabs")]
    ...
    public override void FixedUpdateNetwork()
    {
        ...
        if (Object.HasStateAuthority)
        {
            ...
            int hitCount = Runner.LagCompensation.OverlapBox(checkForImpactPoint.position, gameObject.transform.localScale, gameObject.transform.rotation, firedByPlayerRef, hits, collisionLayers, HitOptions.IncludePhysX);
            print(hitCount);
